    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12 fa-3x font-family ">
                <h1 class="text-center">Activté des Agents</h1>
                <hr>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12 mt-3">
                <div class="row">
                    <form action="{{route('data_activites_agents')}}" method="GET">

                        @csrf
                        <div class="">
                            <div class="mb-5 font-weight-bold font-italic fa-2x justify-content-center">
                                <span> Définir la période sur laquelle évaluer l'activités des agents </span>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                              ...
                              <tbody>
                                @forelse($agents as $agent)
                                    <tr>
                                        ...
                                        <td>{{ $agent->livraisonEffectuees }}</td>
                                        <td>{{ $agent->montantLivrains }}</td>
                                        <td>{{ $agent->fraisLivraisons }}</td>
