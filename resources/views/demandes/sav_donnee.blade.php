                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div>
                                        <h2 class="card-title mb-1" style="font-family: 'Times New Roman'; font-size: x-large;">Liste des demandes Initiées</h2>
                                    </div>
                                                                        <h2 class="card-title mb-1" style="font-family: 'Times New Roman'; font-size: x-large;">Liste des demandes Initiées</h2>
                                </div>
                                <div class="table-responsive">
                                    <table class="dataTable my-datatable table table-hover mg-b-0 table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th style="font-family: 'Palatino Linotype'; font-size:small">Actions</th>
                                                                                            >
                                        </tr>
                                        </thead>
                                        <tbody >
                                        @forelse($demande_livraisons as $demandeLivraison)
                                            <tr>
                                                ...
                                                <td>{{ $demandeLivraison->nom_beneficiaire }}</td>
                                                                                                        ...
                                                                                                        <td>{{ $demandeLivraison->deleted_at }}</td>
                                                <td>
