...
{{--                                    </li>--}}
                                    ...
                                    <li class="p-b-20 row">
                                        ...
                                        <div class="col-sm-8">{{\App\Http\Controllers\DemandeController::prixMill($demande_livraisons?->commission)}}</div>
                                    </li>
                                    <li class="p-b-20 row">
...
{{--                                    </li>--}}
                                    ...
                                    <li class="p-b-20 row">
                                        <div class="col-sm-3 text-muted">Initiée le: </div>
                                        <div class="col-sm-8">{{$demande_livraisons?->created_at}}</div>
                                    </li>
                                    <li class="p-b-20 row">
                        ...
                        <div class="btn btn-list my-4">
                            ...
                            @endif
                            @endadmin
                            @if($demande_livraisons->statut_demande_id == DEMANDE_INITIEE||$demande_livraisons->statut_demande_id == DEMANDE_ENCOURS ||$demande_livraisons->statut_demande_id == DEMANDE_ASSIGNEE)
                            <button class="btn ripple btn-light mx-5" style="background-color: #af3a3a"><a href="#" class="" data-toggle="modal" data-target="#deletedata{{$demande_livraisons->id}}" title="Annuler" onclick="event.preventDefault()">
                                    <i class="btn" style="text-decoration: white" > Annuler</i>
                                </a>
                            </button>
                            @endif
                        </div>

                        <div class="modal" id="deletedata{{$demande_livraisons->id}}">
                            @livewire('motif', ['demande_livraison' => $demande_livraisons ])
                        </div>
            </div>
        </div>
