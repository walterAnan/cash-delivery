...
<html lang="en">
    ...
    <body>
        ...
        @endif
        <div class="row">
            <h4 class="text-right">Date: {{ $invoice->getDate() }}</h4>
        </div>
...
{{--                                Motif: {{ $invoice->seller->address }}--}}
{{--                            </p>--}}
{{--                        @endif--}}

{{--                        @if($invoice->seller->code)--}}
{{--                            <p class="seller-code">--}}
{{--                                Référence: {{ $invoice->seller->code }}--}}
{{--                            </p>--}}
{{--                        @endif--}}

{{--                        @if($invoice->seller->vat)--}}
{{--                            <p class="seller-vat">--}}
{{--                                Montant: {{ $invoice->seller->vat }}--}}
{{--                            </p>--}}
{{--                        @endif--}}

{{--                        @if($invoice->seller->phone)--}}
{{--                            <p class="seller-phone">--}}
{{--                                Téléphone client: {{ $invoice->seller->phone }}--}}
{{--                            </p>--}}
{{--                        @endif--}}
